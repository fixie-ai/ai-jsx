...
[![Discord Follow](https://dcbadge.vercel.app/api/server/MsKAeKF8kU?style=flat)](https://discord.gg/tRMV7PW8f2)
...
:::tip Support
If you're interested in using AI.JSX in production, we're happy to provide first-class support. Ping us in [Discord](https://discord.gg/tRMV7PW8f2) and we can set up a private Slack channel between your team and ours.
:::
