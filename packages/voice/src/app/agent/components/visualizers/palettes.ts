...
export class ColorPalette implements IColorPalette {
  ...
  public static getPalette(type: ColorPaletteType) {
    ...
    switch (type) {
      case COLOR_PALETTE.WARM:
        return new ColorPalette(COLOR_PALETTE.WARM, ['#FF2000', '#FF5900', '#FE9100', '#FEFDFC', '#FEC194', '#FE9F5B']);
      ...
      case COLOR_PALETTE.SAND_2:
        return new ColorPalette(COLOR_PALETTE.SAND_2, ['#f2ead6', '#327172', '#2d3e58', '#f47e72', '#f2cab1']);
      case COLOR_PALETTE.SAND_3:
        return new ColorPalette(COLOR_PALETTE.SAND_3, ['#f1e2c3', '#8595a4', '#8d4f2a', '#d86b28', '#eca956']);
      ...
      case COLOR_PALETTE.THREE_RAINBOW:
        return new ColorPalette(COLOR_PALETTE.THREE_RAINBOW, ['#0000FF', '#00FFFF', '#00FF00', '#FFFF00', '#FF0000']);
  ...
  public static random(options: ColorPaletteType[] = AVAILABLE_COLOR_PALETTES): ColorPalette {
    return ColorPalette.getPalette(options[Math.floor(Math.random() * options.length)]);
  }
}
