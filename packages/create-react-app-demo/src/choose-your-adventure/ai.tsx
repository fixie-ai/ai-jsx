    ...
    <OpenAI chatModel="gpt-4">
      <ChatCompletion>
        <SystemMessage>
          ...
          you the user a question with a finite set of choices, give them buttons to make those choices. Try to make
          the buttons include emoji, when possible. Respond only
